...
def upgrade() -> None:
    ...
    # Renames (new names)
    op.execute("ALTER TYPE tripstatus ADD VALUE IF NOT EXISTS 'Arrived at Loading Point'")
    op.execute("ALTER TYPE tripstatus ADD VALUE IF NOT EXISTS 'Arrived at Loading Point (Return)'")
    op.execute("ALTER TYPE tripstatus ADD VALUE IF NOT EXISTS 'Returning Empty'")
    # New AUTO statuses
    op.execute("ALTER TYPE tripstatus ADD VALUE IF NOT EXISTS 'Loaded'")
    op.execute("ALTER TYPE tripstatus ADD VALUE IF NOT EXISTS 'Loaded (Return)'")
    op.execute("ALTER TYPE tripstatus ADD VALUE IF NOT EXISTS 'Offloaded (Return)'")
    # New MANUAL statuses
    op.execute("ALTER TYPE tripstatus ADD VALUE IF NOT EXISTS 'Arrived at Destination'")
    op.execute("ALTER TYPE tripstatus ADD VALUE IF NOT EXISTS 'Arrived at Destination (Return)'")
